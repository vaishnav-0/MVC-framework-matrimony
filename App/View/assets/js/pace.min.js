 ...
 */
(function() {
    function o(t, e) { return function() { return t.apply(e, arguments) } } var u, c, i, n, y, t, l, v, r, s, a, e, p, w, b, h, f, d, g, m, k, S, q, x, L, P, T, R, j, O, E, M, A, C, N, _, F, U, W, X, D, H, I, z, G, B = [].slice,
        J = {}.hasOwnProperty,
        K = function(t, e) { for (var n in e) J.call(e, n) && (t[n] = e[n]);

            function r() { this.constructor = t } return r.prototype = e.prototype, t.prototype = new r, t.__super__ = e.prototype, t },
        Q = [].indexOf || function(t) { for (var e = 0, n = this.length; e < n; e++)
                if (e in this && this[e] === t) return e;
            return -1 };

    function V() {} for (f = { className: "", catchupTime: 100, initialRate: .03, minTime: 250, ghostTime: 100, maxProgressPerFrame: 20, easeFactor: 1.25, startOnPageLoad: !0, restartOnPushState: !0, restartOnRequestAfter: 500, target: "body", elements: { checkInterval: 100, selectors: ["body"] }, eventLag: { minSamples: 10, sampleCount: 3, lagThreshold: 3 }, ajax: { trackMethods: ["GET"], trackWebSockets: !0, ignoreURLs: [] } }, L = function() { var t; return null != (t = "undefined" != typeof performance && null !== performance && "function" == typeof performance.now ? performance.now() : void 0) ? t : +new Date }, T = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, h = window.cancelAnimationFrame || window.mozCancelAnimationFrame, a = function(t, e, n) { return ("function" == typeof t.addEventListener ? t.addEventListener(e, n, !1) : void 0) || (t["on" + e] = n) }, null == T && (T = function(t) { return setTimeout(t, 50) }, h = function(t) { return clearTimeout(t) }), j = function(e) { var n = L(),
                r = function() { var t = L() - n; return 33 <= t ? (n = L(), e(t, function() { return T(r) })) : setTimeout(r, 33 - t) }; return r() }, R = function() { var t = arguments[0],
                e = arguments[1],
                n = 3 <= arguments.length ? B.call(arguments, 2) : []; return "function" == typeof t[e] ? t[e].apply(t, n) : t[e] }, d = function() { for (var t, e, n, r = arguments[0], s = 2 <= arguments.length ? B.call(arguments, 1) : [], o = 0, i = s.length; o < i; o++)
                if (e = s[o])
                    for (t in e) J.call(e, t) && (n = e[t], null != r[t] && "object" == typeof r[t] && null != n && "object" == typeof n ? d(r[t], n) : r[t] = n);
            return r }, p = function(t) { for (var e, n, r = e = 0, s = 0, o = t.length; s < o; s++) n = t[s], r += Math.abs(n), e++; return r / e }, m = function(t, e) { var n, r; if (null == t && (t = "options"), null == e && (e = !0), r = document.querySelector("[data-pace-" + t + "]")) { if (n = r.getAttribute("data-pace-" + t), !e) return n; try { return JSON.parse(n) } catch (t) { return "undefined" != typeof console && null !== console ? console.error("Error parsing inline pace options", t) : void 0 } } }, V.prototype.on = function(t, e, n, r) { var s; return null == r && (r = !1), null == this.bindings && (this.bindings = {}), null == (s = this.bindings)[t] && (s[t] = []), this.bindings[t].push({ handler: e, ctx: n, once: r }) }, V.prototype.once = function(t, e, n) { return this.on(t, e, n, !0) }, V.prototype.off = function(t, e) { var n, r, s; if (null != (null != (r = this.bindings) ? r[t] : void 0)) { if (null == e) return delete this.bindings[t]; for (n = 0, s = []; n < this.bindings[t].length;) this.bindings[t][n].handler === e ? s.push(this.bindings[t].splice(n, 1)) : s.push(n++); return s } }, V.prototype.trigger = function() { var t, e, n, r, s, o, i = arguments[0],
                a = 2 <= arguments.length ? B.call(arguments, 1) : []; if (null != (r = this.bindings) && r[i]) { for (n = 0, o = []; n < this.bindings[i].length;) e = (s = this.bindings[i][n]).handler, t = s.ctx, s = s.once, e.apply(null != t ? t : this, a), s ? o.push(this.bindings[i].splice(n, 1)) : o.push(n++); return o } }, G = V, y = window.Pace || {}, window.Pace = y, d(y, G.prototype), P = y.options = d({}, f, window.paceOptions, m()), W = 0, D = (I = ["ajax", "document", "eventLag", "elements"]).length; W < D; W++) !0 === P[A = I[W]] && (P[A] = f[A]);
    ...
    function tt() { var e, o = this;
        tt.__super__.constructor.apply(this, arguments), e = function(r) { var s = r.open; return r.open = function(t, e, n) { return M(t) && o.trigger("request", { type: t, url: e, request: r }), s.apply(r, arguments) } }, window.XMLHttpRequest = function(t) { t = new U(t); return e(t), t }; try { g(window.XMLHttpRequest, U) } catch (t) {} if (null != F) { window.XDomainRequest = function() { var t = new F; return e(t), t }; try { g(window.XDomainRequest, F) } catch (t) {} } if (null != _ && P.ajax.trackWebSockets) { window.WebSocket = function(t, e) { var n = null != e ? new _(t, e) : new _(t); return M("socket") && o.trigger("request", { type: "socket", url: t, protocols: e, request: n }), n }; try { g(window.WebSocket, _) } catch (t) {} } }

    function et() { this.complete = o(this.complete, this); var t = this;
        this.elements = [], k().on("request", function() { return t.watch.apply(t, arguments) }) }

    function nt(t) { var e, n, r, s; for (null == t && (t = {}), this.complete = o(this.complete, this), this.elements = [], null == t.selectors && (t.selectors = []), n = 0, r = (s = t.selectors).length; n < r; n++) e = s[n], this.elements.push(new i(e, this.complete)) }

    function rt(t, e) { this.selector = t, this.completeCallback = e, this.progress = 0, this.check() }

    function st() { var t, e, n = this;
